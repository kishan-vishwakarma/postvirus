			...
			<div class="container">
				<div class="main-header-left ">
					...
					<a class="header-brand" href="#">
						<img src="assets/img/header photo/app_logo.png" class="desktop-logo logo-color1" alt="img">
					</a>
				</div><!-- search -->
				<div class="main-header-center">
				<img src="assets/img/header photo/name2.png"  alt="img">
				</div>
				...
				<div class="main-header-right">
					<div class="nav nav-item  navbar-nav-right ml-auto">
						...
						<div class="dropdown main-profile-menu nav nav-item nav-link">
							<a class="profile-user d-flex" href="#"><img alt="" src="assets/img/header photo/1.png">
							...
							<div class="dropdown-menu">
								<div class="main-header-profile header-img">
									<div class="main-img-user"><img alt="" src="assets/img/header photo/1.png"></div>
