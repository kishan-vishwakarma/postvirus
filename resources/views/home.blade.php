...
@section('title' , 'राजीव युवा मितान क्लब (RYMC) | दुर्ग ')
@section('content')
<!-- main-content opened -->
                  ...
                  <div class="row">
                    <div class="col-6 text-center">
                      <div class="mb-1 d-flex">
                        <div class="ht-10 wd-20 bg-primary mt-1 mr-2 rounded-5"></div> Traveling
                      </div>
                    </div>
                    <div class="col-6 text-center">
                      <div class="mb-1 d-flex">
                        <div class="ht-10 wd-20 bg-success mt-1 mr-2 rounded-5"></div> Pressentation
                      </div>
                    </div>
                    <div class="col-6 text-center">
                      <div class="mb-1 d-flex">
                        <div class="ht-10 wd-20 bg-warning mt-1 mr-2 rounded-5"></div> Business
                      </div>
                    </div>
                    <div class="col-6 text-center">
                      <div class="mb-1 d-flex">
                ...
                <tbody>
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround">S</span><span class="mg-l-10 mg-t-7">SREE Enrprices</span></div>
                    </td>
                    <td>20,125</td>
                    <td>10513.00</td>
                    <td>Watch</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-success">G</span><span class="mg-l-10 mg-t-7">Granite Cake</span></div>
                    </td>
                    <td>1,250,103</td>
                    <td>425.25</td>
                    <td>Medical</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-secondary">G</span><span class="mg-l-10 mg-t-7">GOODS Best</span></div>
                    </td>
                    <td>425.25</td>
                    <td>1.2029</td>
                    <td>Cake</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-info">M</span><span class="mg-l-10 mg-t-7">Multi Shop</span></div>
                    </td>
                    <td>28,470</td>
                    <td>1547.67</td>
                    <td>Elactronics</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-warning">S</span><span class="mg-l-10 mg-t-7">Sagar Limited</span></div>
                    </td>
                    <td>24,983</td>
                    <td>723.48</td>
                    <td>Mobile</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-success">I</span><span class="mg-l-10 mg-t-7">Indo Allinone</span></div>
                    </td>
                    <td>81,865</td>
                    <td>149.18</td>
                    <td>Fashion</td>
                  ...
                  <tr>
                    <td class="font-weight-bold">
                      <div class="d-flex"><span class="avatar avatar-sm brround bg-danger">S</span><span class="mg-l-10 mg-t-7">Spark Limited</span></div>
                    </td>
                    <td>32,309</td>
                    <td>149.18</td>
                    <td>Gift</td>
